...
export class ReportsService {
  ...
  getNumberOfLearnersByDistrictPerGrade(districtID:number){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getNumberOfLearnersByDistrctPergrade/${districtID}`)
  }

  getNumberOfLearnersInGauteng(){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getNumberOfLearnersForAllGradesInGauteng`)
  }

  getCompletedCount(){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getCompleted`)
  }

  getInProgressCount(){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getInprogress`)
  }

  getNotstartedCount(){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getNotStarted`)
  }

  getCompletedCountByDistrictID(districtID:number){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getCompletedCountByDistrict/${districtID}`)
  }
  getInProgressCountByDistrictID(districtID:number){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getInProgressCountByDistrict/${districtID}`)
  }
  getNotStartedCountByDistrictID(districtID:number){
    return this.http.get<any>(`${environment.headCountUrl}/reports/getNotStartedCountByDistrict/${districtID}`)
  }
}
