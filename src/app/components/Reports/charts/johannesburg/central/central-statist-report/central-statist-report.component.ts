...
@Component({
  selector: 'app-central-statist-report',
  templateUrl: './central-statist-report.component.html',
  styleUrls: ['./central-statist-report.component.scss']
})
export class CentralStatistReportComponent {
  inProgress:any
  label:any
  notStarted: any;
  completed: any;
  ...
  ngOnInit(): void {
    this.report.getNumberOfLearnersByDistrictPerGrade(this.districtID).subscribe(result => {
      this.data = result
      if (this.data!=null) {
