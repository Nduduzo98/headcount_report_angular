...
@Component({
  selector: 'app-gw-submission-stat',
  templateUrl: './gw-submission-stat.component.html',
  styleUrls: ['./gw-submission-stat.component.scss']
})
export class GwSubmissionStatComponent {
