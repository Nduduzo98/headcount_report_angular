...
@Component({
  selector: 'app-tn-submission-stat',
  templateUrl: './tn-submission-stat.component.html',
  styleUrls: ['./tn-submission-stat.component.scss']
})
export class TnSubmissionStatComponent {
