...
@Component({
  selector: 'app-tw-submission-stat',
  templateUrl: './tw-submission-stat.component.html',
  styleUrls: ['./tw-submission-stat.component.scss']
})
export class TwSubmissionStatComponent {
