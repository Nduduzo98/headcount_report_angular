...
@Component({
  selector: 'app-tw-inprogress',
  templateUrl: './tw-inprogress.component.html',
  styleUrls: ['./tw-inprogress.component.scss']
})
export class TwInprogressComponent {
