...
@Component({
  selector: 'app-ts-inprogress',
  templateUrl: './ts-inprogress.component.html',
  styleUrls: ['./ts-inprogress.component.scss']
})
export class TsInprogressComponent {
