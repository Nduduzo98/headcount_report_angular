...
@Component({
  selector: 'app-ts-submission-stat',
  templateUrl: './ts-submission-stat.component.html',
  styleUrls: ['./ts-submission-stat.component.scss']
})
export class TsSubmissionStatComponent {
